                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _ref2 = this.id ? ['PUT', '/interpretations/' + interpretation.id + '/comments/' + this.id] : ['POST', '/interpretations/' + interpretation.id + '/comments'], _ref3 = (0, _slicedToArray3.default)(_ref2, 2), method = _ref3[0], url = _ref3[1];
                                _context.next = 4;
